...
const defaultClass: string =
  'px-4 py-1 text-white	bg-[#1fc7d4] font-kanit font-base font-semibold rounded-full shadow-sm shadow-gray-700 hover:opacity-60 active:translate-y-px active:shadow-none';
